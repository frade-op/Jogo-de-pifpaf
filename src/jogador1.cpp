...
void mudar1(){
	...
	novo=mao1[posicao-1];//tira a carta desejada da m�o
	naipe_novo=naipe1[posicao-1];//tira a carta desejada da m�o
	
	mao1[posicao-1]=mao1[nova_posicao-1];//tira a carta que ocupa o lugar da desejada e realoca na posi��o antiga
	naipe1[posicao-1]=naipe1[nova_posicao-1];//tira a carta que ocupa o lugar da desejada e realoca na posi��o antiga
	
	mao1[nova_posicao-1]=novo;//coloca a carta desejada na posi��o desejada
	naipe1[nova_posicao-1]=naipe_novo;//coloca a carta desejada na posi��o desejada
...
void compar1(){
	...
	if(simnao==1){//decidiu guarda-la
		...
		mao1[posicao-1]=novo;//coloca a carta nova na m�o
		naipe1[posicao-1]=naipe_novo;//coloca a carta nova na m�o
		apresenta1();
...
void monte1(){
	printf("\nAonde deseja coloca-la?\n");//aonde
	scanf("%i", &posicao);
	novo=mao1[posicao-1];//tira a carta da m�o
	naipe_novo=naipe1[posicao-1];//tira a carta da m�o
