...
int mudar4(){
	...
	novo=mao4[posicao-1];//tira a carta desejada da m�o
	naipe_novo=naipe4[posicao-1];//tira a carta desejada da m�o
	
	mao4[posicao-1]=mao4[nova_posicao-1];//tira a carta que ocupa o lugar da desejada e realoca na posi��o antiga
	naipe4[posicao-1]=naipe4[nova_posicao-1];//tira a carta que ocupa o lugar da desejada e realoca na posi��o antiga
	
	mao4[nova_posicao-1]=novo;//coloca a carta desejada na posi��o desejada
	naipe4[nova_posicao-1]=naipe_novo;//coloca a carta desejada na posi��o desejada
...
int compar4(){
	...
	if(simnao==1){//decidiu guarda-la
		...
		mao4[posicao-1]=novo;//coloca a carta nova na m�o
		naipe4[posicao-1]=naipe_novo;//coloca a carta nova na m�o
		apresenta4();
...
int monte4(){
	...
	naipe_novo=naipe4[posicao-1];//tira a carta da m�o
