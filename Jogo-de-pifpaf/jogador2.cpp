...
int mudar2(){
	...
	novo=mao2[posicao-1];//tira a carta desejada da mão
	naipe_novo=naipe2[posicao-1];//tira a carta desejada da mão
	
	mao2[posicao-1]=mao2[nova_posicao-1];//tira a carta que ocupa o lugar da desejada e realoca na posição antiga
	naipe2[posicao-1]=naipe2[nova_posicao-1];//tira a carta que ocupa o lugar da desejada e realoca na posição antiga
	
	mao2[nova_posicao-1]=novo;//coloca a carta desejada na posição desejada
	naipe2[nova_posicao-1]=naipe_novo;//coloca a carta desejada na posição desejada
...
int compar2(){
	...
	if(simnao==1){//decidiu guarda-la
		...
		mao2[posicao-1]=novo;//coloca a carta nova na mão
		naipe2[posicao-1]=naipe_novo;//coloca a carta nova na mão
		apresenta2();
...
int monte2(){
	printf("\nAonde deseja coloca-la?\n");//aonde
	scanf("%i", &posicao);
	novo=mao2[posicao-1];//tira a carta da mão
	naipe_novo=naipe2[posicao-1];//tira a carta da mão
